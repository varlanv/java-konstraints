...
public final class RootIndexedStringAssertions<TARGET extends CharSequence, ROOT, CURRENT>
    ...
    public RootIndexedStringAssertions<TARGET, ROOT, CURRENT> check(
            BiFunction<@NotNull String, TARGET, @NotNull Violation> violation, Predicate<@NotNull TARGET> action) {
        return null;
    }

    public RootIndexedStringAssertions<TARGET, ROOT, CURRENT> checkIndexed(
            IndexBiFunction<@NotNull String, TARGET, @NotNull Violation> violation,
            IndexPredicate<@NotNull TARGET> action) {
        return null;
    }

    public RootIndexedStringAssertions<TARGET, ROOT, CURRENT> checkContextual(
    ...
    @Override
    public RootIndexedStringAssertions<TARGET, ROOT, CURRENT> check(String message, Predicate<@NotNull TARGET> action) {
        return null;
    }
