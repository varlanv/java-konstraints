...
public final class RootIterableSpec<ROOT, CURRENT> extends BaseIterableSpec<ROOT, CURRENT> {
    ...
    public <ITEM extends CharSequence, ITEMS extends Iterable<ITEM>> RootAssertionsSpec<ROOT, CURRENT> strings(
            Function<@NotNull CURRENT, @Nullable ITEMS> extract,
            Function<
                            @NotNull RootStringIterableAssertions<ITEM, ITEMS, CURRENT, ROOT>,
                            @NotNull RootStringIterableAssertions<ITEM, ITEMS, CURRENT, ROOT>>
                    action) {
        return null;
    }
