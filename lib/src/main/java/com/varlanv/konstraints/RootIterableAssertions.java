...
public final class RootIterableAssertions<
        ASSERTIONS extends BaseAssertionsSpec<ROOT, ITEM>, ITEM, ITEMS extends Iterable<ITEM>, ROOT, CURRENT> {

    public ASSERTIONS assertions() {
        return null;
    }

    public RootIterableAssertions<ASSERTIONS, ITEM, ITEMS, ROOT, CURRENT> assertSize(Integer size) {
        return null;
    }

    public RootIterableAssertions<ASSERTIONS, ITEM, ITEMS, ROOT, CURRENT> assertMinSize(Integer minSize) {
        return null;
    }

    public RootIterableAssertions<ASSERTIONS, ITEM, ITEMS, ROOT, CURRENT> assertMaxSize(Integer maxSize) {
        return null;
    }
