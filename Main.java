...
public class Main {
  ...
  static final Function<Rec, Valid<Rec>> strValue =
      Valid.<Rec>validationSpec(rec -> rec
              .field("strValue")
                      ...
                      .nested(Nested2::nestedListVals, nestedListVals -> nestedListVals
                          .eachItem(nestedListVal ->
                              nestedListVal
                                  ...
                                  .nonNull()
                                  .iterable()
                                  .nested(NestedListVal1::nestedListVals2, nestedListVals2 ->
                                      nestedListVals2.eachItem(
                                          nestedListVal2 -> nestedListVal2
                                              .field("val4")
                                              .nonNull()
                                              .number(NestedListVal2::val4,
                                                  val4 -> val4
                                                      .assertInRange(1, 6)
                                              )
                                      )
